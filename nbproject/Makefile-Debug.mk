...
${OBJECTDIR}/AICharacter.o: AICharacter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AICharacter.o AICharacter.cpp

${OBJECTDIR}/CharacterPrototype.o: CharacterPrototype.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CharacterPrototype.o CharacterPrototype.cpp

${OBJECTDIR}/CharacterPrototypeFactory.o: CharacterPrototypeFactory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CharacterPrototypeFactory.o CharacterPrototypeFactory.cpp

${OBJECTDIR}/PlayableCharacter.o: PlayableCharacter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PlayableCharacter.o PlayableCharacter.cpp
